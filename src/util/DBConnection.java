...
public class DBConnection {
    ...
    private static final String URL =
            "jdbc:sqlserver://localhost:1433;databaseName=QuanLyNhaThuoc;encrypt=true;trustServerCertificate=true";
    private static final String USERNAME = "chivi";
    private static final String PASSWORD = "123";
    ...
    static {
        try {
            ...
            throw new RuntimeException("Không tìm thấy JDBC Driver SQLServer: " + e.getMessage(), e);
        }
    }
    ...
    public static Connection getConnection() {
        try {
            ...
            throw new RuntimeException("Lỗi kết nối SQL Server: " + e.getMessage(), e);
        }
    }
}